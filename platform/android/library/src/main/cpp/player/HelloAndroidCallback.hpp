...
#ifndef HELLOPLAYER_HELLOANDROIDCALLBACK_HPP
#define HELLOPLAYER_HELLOANDROIDCALLBACK_HPP

#include "../jni/JniInit.hpp"
 ...
 * Description:
 **/
class HelloAndroidCallback : public HelloPlayerCallback {
public:
    explicit HelloAndroidCallback(void* userdata = nullptr);
    ~HelloAndroidCallback() override;
...
#endif //HELLOPLAYER_HELLOANDROIDCALLBACK_HPP
