...
#include "entity/TextureData.hpp"
...
{
public:
    explicit IGLProgram(const char* tag = "IGLProgram");
     ...
     * @param count 纹理个数
     */
    virtual void setTexture(GLuint *textures, int count);

    /**
     * @param data 设置纹理数据
     */
    virtual void setTextureData(std::shared_ptr<TextureData> data);
